...
app.post('/api/gift_suggestion', async (req, res) => {
  try {
    ...
    const prompt = `Can you recommend me 12 specific brand name products as gifts for a ${age} year old ${gender} who is my ${relationship} and likes ${interests}, with a budget of ${price}. 
...
app.post('/api/related_gifts', async (req, res) => {
  try {
    ...
    const prompt = `Can you recommend me 12 specific brand name products that are similar to or complement ${product_name}, with a budget of ${price}. 
